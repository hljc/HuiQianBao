...
public class Util_Screen {
    ...
    public static void statusBarToTranslucent(Activity activity, int dynamicStatusColor) {
        statusBarToTranslucent(activity, dynamicStatusColor, null);
    }
...
/*    public static void statusBarToTranslucentAndFits(Activity activity, int statusColor, boolean fitsSystemWindows) {
    ...
    public static void statusBarToTranslucent(Activity activity, int dynamicStatusColor, Enum_BarFontColor enum_barFontColor) {
        int staticStatusColor = activity.getResources().getColor(R.color.title_background);
        staticStatusColor = setStatusBarColor(activity, staticStatusColor, enum_barFontColor);
        dynamicStatusColor = setStatusBarColor(activity, dynamicStatusColor, enum_barFontColor);
        int statusColor = dynamicStatusColor == Integer.MAX_VALUE ? staticStatusColor : dynamicStatusColor;
        BarUtils.setStatusBarColor(activity,statusColor,0);
        setStatusBarColor(activity, staticStatusColor, enum_barFontColor);
        setStatusBarColor(activity, dynamicStatusColor, enum_barFontColor);
    }


    private static int setStatusBarColor(Activity activity, int xmlStatusColor, Enum_BarFontColor enum_barFontColor) {
        boolean dark = enum_barFontColor == null || enum_barFontColor == Enum_BarFontColor.Black;
        switch (xmlStatusColor) {
            case Color.WHITE:
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    ...
                    xmlStatusColor = Color.parseColor("#dddddd");
                break;
            case Color.BLACK:
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    if (!dark)
                    ...
                    xmlStatusColor = Color.parseColor("#111111");
                break;
        }
        return xmlStatusColor;
    }
