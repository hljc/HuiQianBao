...
public class PasswordView extends RelativeLayout {
    ...
    TextView tv_title, tv_amount, tv_remark;
    ...
    public void setMoney(String amount) {
        tv_amount.setText("￥".concat((String) Util_Empty.isEmptyToReplace(amount,"0.00")));
    }

    public void setRemark(String remark) {
        tv_remark.setText((CharSequence) Util_Empty.isEmptyToReplace(remark,""));
    }
