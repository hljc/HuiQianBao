...
public class Act_Mine_Settings extends Framework_Activity {
    ImageView iv_back;
    ...
    public void initData() {
        functionList1.add(new Bean_Item("收益分析", R.mipmap.icon_income_analysis, false));
        functionList1.add(new Bean_Item("更换手机号", R.mipmap.icon_settings_modifymobile, false));

        functionList2.add(new Bean_Item("用户协议", R.mipmap.icon_settings_protocol, false));

        functionList3.add(new Bean_Item("版本更新", AppUtils.getAppVersionName(AppUtils.getAppPackageName()), R.mipmap.icon_settings_upgrade, false));
    }
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
                ...
                mvh.rl_bg.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        switch (position) {
                            case 0:
                                startActivity(new Intent(getActivity(), Act_Settings_Income.class));
                                break;
                            case 1:
                                Util_Toast.toast(Constants_International.framework_function_no_open);
                               // startActivity(new Intent(getActivity(), Act_Settings_ModifyMobile.class));
                                break;
                        }
                    }
                });
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
                ...
                mvh.rl_bg.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        switch (position) {
                            case 0:
                                startActivity(new Intent(getActivity(), Act_Settings_Protocol.class));
                                break;
                            case 1:
