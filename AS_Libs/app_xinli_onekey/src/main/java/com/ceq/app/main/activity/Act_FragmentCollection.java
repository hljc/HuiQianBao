...
public class Act_FragmentCollection extends Framework_Activity {
    ...
    public void initFragment() {
        ...
        util_fragment.fragmentToInit((FragmentActivity) getActivity(), R.id.rl_fragment, new Util_Fragment.InitFragment() {
            ...
            public void initFragment(TreeMap<Integer, Fragment> treeMap) {
                Fragment fragment =Act_Main_Module.util_fragment.getTm_fragment().get(Method_Static.getModuleFragmentPosition(Enum_OKModule_Feature.收款));
                if (fragment != null)
